...
export const DEFAULT_CATEGORIES = [
  { name: 'Housing',                  color: '#1a6b3a', description: 'Rent, mortgage, HOA',              enabled: true,  is_system: false, sort_order: 0  },
  { name: 'Transport',                color: '#1a3a6b', description: 'Car, gas, insurance',              enabled: true,  is_system: false, sort_order: 1  },
  ...
  { name: 'Health',                   color: '#8b1a1a', description: 'Insurance, meds, gym, dental',     enabled: true,  is_system: false, sort_order: 5  },
  ...
  { name: 'Other',                    color: '#4a4a4a', description: 'Miscellaneous',                    enabled: true,  is_system: false, sort_order: 16 },
